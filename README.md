...
1. 객체 지향에 개념에 대한 간략한 설명 이후 
2. 실세계의 모델을 기반으로 객체 관점에서 소스를 먼저 개략적으로 구현하고,
3. 이후 각각 객체지향의 특징들의 설명과 함께 소스 또한 변경해 나갈 예정입니다.
...
특징이 나오게 됩니다. 이는 곧 아래의 실 세계의 모델을 객체지향 모델로 바꿔가면서 각 특징들에 대해 설명해 보겠습니다.
